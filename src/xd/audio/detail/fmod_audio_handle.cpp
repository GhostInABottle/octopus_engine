...
namespace xd::detail {
    ...
    static FMOD_RESULT F_CALL file_open(const char* name, unsigned int* file_size, void** handle, void* user_data) {
    ...
    static FMOD_RESULT F_CALL file_close([[maybe_unused]] void* handle, [[maybe_unused]] void* user_data) {
        return FMOD_OK;
    }

    static FMOD_RESULT F_CALL file_read([[maybe_unused]] void* handle, void* buffer, unsigned int size_bytes,
    ...
    static FMOD_RESULT F_CALL file_seek([[maybe_unused]] void* handle, unsigned int pos, void* user_data) {
        auto istream = static_cast<std::istream*>(user_data);
