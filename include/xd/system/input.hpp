...
namespace xd
{
    ...
    extern const key KEY_GRAVEACCENT;
    extern const key KEY_HOME;
    extern const key KEY_INSERT;
    extern const key KEY_NUMPAD0;
    extern const key KEY_NUMPAD1;
    extern const key KEY_NUMPAD2;
    extern const key KEY_NUMPAD3;
    extern const key KEY_NUMPAD4;
    extern const key KEY_NUMPAD5;
    extern const key KEY_NUMPAD6;
    extern const key KEY_NUMPAD7;
    extern const key KEY_NUMPAD8;
    extern const key KEY_NUMPAD9;
    extern const key KEY_NUMPADPLUS;
    extern const key KEY_NUMPADDECIMAL;
    extern const key KEY_NUMPADDIVIDE;
    extern const key KEY_NUMPADENTER;
    extern const key KEY_NUMPADEQUAL;
    extern const key KEY_NUMPADTIMES;
    extern const key KEY_NUMPADMINUS;
    extern const key KEY_LBRACKET;
    extern const key KEY_RBRACKET;
    extern const key KEY_LSUPER;
    extern const key KEY_RSUPER;
    extern const key KEY_MENU;
    extern const key KEY_MINUS;
    extern const key KEY_NUMLOCK;
    extern const key KEY_PAGEDOWN;
    extern const key KEY_PAGEUP;
    extern const key KEY_PAUSE;
    extern const key KEY_PERIOD;
    extern const key KEY_PRTSCN;
